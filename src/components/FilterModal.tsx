...
export default function FilterModal({
  ...
  return createPortal(
    <div className="form-modal filter-modal" role="dialog" aria-modal="true" aria-labelledby="filter-modal-title">
      ...
      <div className="form-modal-panel filter-modal-panel">
        ...
        <div className="form-actions form-modal-actions filter-modal-actions">
          {onClear && (
            <button type="button" className="btn btn-secondary filter-modal-clear" onClick={onClear}>
              پاک کردن
            </button>
          )}
